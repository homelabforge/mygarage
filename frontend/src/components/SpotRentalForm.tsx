...
export default function SpotRentalForm({ vin, rental, onClose, onSuccess }: SpotRentalFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      nightly_rate: rental?.nightly_rate?.toString() || '',
      weekly_rate: rental?.weekly_rate?.toString() || '',
      monthly_rate: rental?.monthly_rate?.toString() || '',
      electric: rental?.electric?.toString() || '',
      water: rental?.water?.toString() || '',
      waste: rental?.waste?.toString() || '',
      total_cost: rental?.total_cost?.toString() || '',
