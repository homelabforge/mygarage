...
- `feat: add bulk vehicle import from CSV`
- `fix: correct MPG calculation for partial tank fill-ups`
- `docs: update PostgreSQL setup instructions`
- `refactor: optimize service record query performance`
...
- [ ] I'm okay with my contribution being included in MyGarage
