...
CREATE TABLE public.attachments (
    ...
    CONSTRAINT check_record_type CHECK (((record_type)::text = ANY ((ARRAY['service'::character varying, 'service_visit'::character varying, 'fuel'::character varying, 'upgrade'::character varying, 'collision'::character varying, 'tax'::character varying, 'note'::character varying])::text[])))
);
...
CREATE TABLE public.fuel_records (
    ...
    fuel_type_used character varying(20),
    ...
    station_name_freetext character varying(150),
    driver_user_id integer,
    driver_name_freetext character varying(100),
    payment_method character varying(20),
    trip_type character varying(20),
    outside_temp_c numeric(4,1),
    obc_l_per_100km numeric(5,2),
    obc_avg_speed_kmh numeric(5,1),
    obc_trip_duration_s integer,
...
CREATE TABLE public.insurance_policies (
    ...
    CONSTRAINT check_policy_type CHECK (((policy_type)::text = ANY ((ARRAY['Liability'::character varying, 'Comprehensive'::character varying, 'Collision'::character varying, 'Full Coverage'::character varying, 'Minimum'::character varying, 'Other'::character varying])::text[]))),
    CONSTRAINT check_premium_frequency CHECK (((premium_frequency)::text = ANY ((ARRAY['Monthly'::character varying, 'Quarterly'::character varying, 'Semi-Annual'::character varying, 'Annual'::character varying])::text[])))
);
...
CREATE TABLE public.service_line_items (
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    CONSTRAINT check_inspection_result CHECK (((inspection_result IS NULL) OR ((inspection_result)::text = ANY ((ARRAY['passed'::character varying, 'failed'::character varying, 'needs_attention'::character varying])::text[])))),
    CONSTRAINT check_inspection_severity CHECK (((inspection_severity IS NULL) OR ((inspection_severity)::text = ANY ((ARRAY['green'::character varying, 'yellow'::character varying, 'red'::character varying])::text[]))))
);
...
CREATE TABLE public.service_visits (
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    updated_at timestamp without time zone,
    CONSTRAINT check_service_visit_category CHECK (((service_category)::text = ANY ((ARRAY['Maintenance'::character varying, 'Inspection'::character varying, 'Collision'::character varying, 'Upgrades'::character varying, 'Detailing'::character varying])::text[])))
);
...
CREATE TABLE public.tax_records (
    ...
    notes text,
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    CONSTRAINT check_tax_type CHECK (((tax_type)::text = ANY ((ARRAY['Registration'::character varying, 'Inspection'::character varying, 'Property Tax'::character varying, 'Tolls'::character varying])::text[])))
);
...
CREATE TABLE public.trailer_details (
    ...
    CONSTRAINT check_brake_type CHECK (((brake_type)::text = ANY ((ARRAY['None'::character varying, 'Electric'::character varying, 'Hydraulic'::character varying])::text[]))),
    CONSTRAINT check_hitch_type CHECK (((hitch_type)::text = ANY ((ARRAY['Ball'::character varying, 'Pintle'::character varying, 'Fifth Wheel'::character varying, 'Gooseneck'::character varying])::text[])))
);
...
CREATE TABLE public.users (
    ...
    default_trip_type character varying(20),
...
CREATE TABLE public.vehicles (
    ...
    cylinders integer,
    fuel_type character varying(50),
    fuel_type_secondary character varying(20),
    ...
    CONSTRAINT check_vehicle_type CHECK (((vehicle_type)::text = ANY ((ARRAY['Car'::character varying, 'Truck'::character varying, 'SUV'::character varying, 'Motorcycle'::character varying, 'RV'::character varying, 'Trailer'::character varying, 'FifthWheel'::character varying, 'TravelTrailer'::character varying, 'Electric'::character varying, 'Hybrid'::character varying])::text[])))
);
...
CREATE TABLE public.warranty_records (
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    last_notified_at timestamp without time zone,
    CONSTRAINT check_warranty_type CHECK (((warranty_type)::text = ANY ((ARRAY['Manufacturer'::character varying, 'Powertrain'::character varying, 'Extended'::character varying, 'Bumper-to-Bumper'::character varying, 'Emissions'::character varying, 'Corrosion'::character varying, 'Other'::character varying])::text[])))
);
...
--
-- Name: idx_fuel_records_driver_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fuel_records_driver_id ON public.fuel_records USING btree (driver_user_id);


--
-- Name: idx_fuel_records_filled_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fuel_records_filled_at ON public.fuel_records USING btree (filled_at);
...
--
-- Name: idx_fuel_records_station_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fuel_records_station_id ON public.fuel_records USING btree (station_address_book_id);


--
-- Name: idx_fuel_records_trip_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fuel_records_trip_type ON public.fuel_records USING btree (trip_type);
...
--
-- Name: fuel_records fk_fuel_records_driver_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fuel_records
    ADD CONSTRAINT fk_fuel_records_driver_user FOREIGN KEY (driver_user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: fuel_records fk_fuel_records_station_address_book; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fuel_records
    ADD CONSTRAINT fk_fuel_records_station_address_book FOREIGN KEY (station_address_book_id) REFERENCES public.address_book(id) ON DELETE SET NULL;


--
-- Name: fuel_records fuel_records_driver_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fuel_records
    ADD CONSTRAINT fuel_records_driver_user_id_fkey FOREIGN KEY (driver_user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: fuel_records fuel_records_station_address_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fuel_records
    ADD CONSTRAINT fuel_records_station_address_book_id_fkey FOREIGN KEY (station_address_book_id) REFERENCES public.address_book(id) ON DELETE SET NULL;
...
INSERT INTO public.schema_migrations VALUES (1, '001_add_vin_fields', '2026-05-05 13:39:25.981939');
INSERT INTO public.schema_migrations VALUES (2, '002_update_address_book_schema', '2026-05-05 13:39:25.98434');
INSERT INTO public.schema_migrations VALUES (3, '003_add_window_sticker_fields', '2026-05-05 13:39:25.987384');
INSERT INTO public.schema_migrations VALUES (4, '004_add_window_sticker_enhanced_fields', '2026-05-05 13:39:25.98987');
INSERT INTO public.schema_migrations VALUES (5, '005_add_vehicle_photo_thumbnails', '2026-05-05 13:39:25.991973');
INSERT INTO public.schema_migrations VALUES (6, '006_update_service_type_constraint', '2026-05-05 13:39:25.992508');
INSERT INTO public.schema_migrations VALUES (7, '007_add_fuel_hauling_column', '2026-05-05 13:39:25.99469');
INSERT INTO public.schema_migrations VALUES (8, '008_add_spot_rental_utilities', '2026-05-05 13:39:25.996819');
INSERT INTO public.schema_migrations VALUES (9, '009_add_fuel_propane_column', '2026-05-05 13:39:25.999196');
INSERT INTO public.schema_migrations VALUES (10, '010_migrate_to_argon2', '2026-05-05 13:39:26.004377');
INSERT INTO public.schema_migrations VALUES (11, '011_add_oidc_fields', '2026-05-05 13:39:26.013183');
INSERT INTO public.schema_migrations VALUES (12, '012_security_hardening', '2026-05-05 13:39:26.015385');
INSERT INTO public.schema_migrations VALUES (13, '013_add_user_id_to_vehicles', '2026-05-05 13:39:26.017556');
INSERT INTO public.schema_migrations VALUES (14, '014_hydrate_legacy_photos', '2026-05-05 13:39:26.046628');
INSERT INTO public.schema_migrations VALUES (15, '015_add_oidc_pending_links', '2026-05-05 13:39:26.048243');
INSERT INTO public.schema_migrations VALUES (16, '016_add_unit_preference', '2026-05-05 13:39:26.050634');
INSERT INTO public.schema_migrations VALUES (17, '017_add_vehicle_archive', '2026-05-05 13:39:26.05299');
INSERT INTO public.schema_migrations VALUES (18, '018_add_spot_rental_billings', '2026-05-05 13:39:26.053551');
INSERT INTO public.schema_migrations VALUES (19, '019_add_ev_support', '2026-05-05 13:39:26.055679');
INSERT INTO public.schema_migrations VALUES (20, '020_add_travel_trailer_type', '2026-05-05 13:39:26.055927');
INSERT INTO public.schema_migrations VALUES (21, '021_add_propane_tank_columns', '2026-05-05 13:39:26.058302');
INSERT INTO public.schema_migrations VALUES (22, '022_redesign_service_type_schema', '2026-05-05 13:39:26.058858');
INSERT INTO public.schema_migrations VALUES (23, '023_add_maintenance_templates', '2026-05-05 13:39:26.059374');
INSERT INTO public.schema_migrations VALUES (24, '024_add_tsbs_table', '2026-05-05 13:39:26.062573');
INSERT INTO public.schema_migrations VALUES (25, '025_add_shop_finder_fields', '2026-05-05 13:39:26.064985');
INSERT INTO public.schema_migrations VALUES (26, '026_add_detailing_category', '2026-05-05 13:39:26.065501');
INSERT INTO public.schema_migrations VALUES (27, '027_add_poi_support', '2026-05-05 13:39:26.069008');
INSERT INTO public.schema_migrations VALUES (28, '028_maintenance_overhaul', '2026-05-05 13:39:26.075097');
INSERT INTO public.schema_migrations VALUES (29, '029_cleanup_migrated_reminders', '2026-05-05 13:39:26.075623');
INSERT INTO public.schema_migrations VALUES (30, '030_migrate_service_attachments', '2026-05-05 13:39:26.077161');
INSERT INTO public.schema_migrations VALUES (31, '031_add_service_cost_breakdown', '2026-05-05 13:39:26.079485');
INSERT INTO public.schema_migrations VALUES (32, '032_add_livelink_tables', '2026-05-05 13:39:26.082091');
INSERT INTO public.schema_migrations VALUES (33, '033_seed_dtc_definitions', '2026-05-05 13:39:26.08235');
INSERT INTO public.schema_migrations VALUES (34, '034_add_livelink_settings', '2026-05-05 13:39:26.084054');
INSERT INTO public.schema_migrations VALUES (35, '035_add_odometer_source', '2026-05-05 13:39:26.087226');
INSERT INTO public.schema_migrations VALUES (36, '036_add_mqtt_settings', '2026-05-05 13:39:26.088842');
INSERT INTO public.schema_migrations VALUES (37, '037_add_family_multiuser_system', '2026-05-05 13:39:26.091107');
INSERT INTO public.schema_migrations VALUES (38, '038_add_def_tracking', '2026-05-05 13:39:26.094235');
INSERT INTO public.schema_migrations VALUES (39, '039_backfill_service_visit_totals', '2026-05-05 13:39:26.094892');
INSERT INTO public.schema_migrations VALUES (40, '040_drop_service_records_table', '2026-05-05 13:39:26.095298');
INSERT INTO public.schema_migrations VALUES (41, '041_add_def_entry_type_and_fuel_link', '2026-05-05 13:39:26.098113');
INSERT INTO public.schema_migrations VALUES (42, '042_add_session_grace_period', '2026-05-05 13:39:26.10022');
INSERT INTO public.schema_migrations VALUES (43, '043_add_mobile_quick_entry_preference', '2026-05-05 13:39:26.102013');
INSERT INTO public.schema_migrations VALUES (44, '044_sync_address_book_to_vendors', '2026-05-05 13:39:26.103007');
INSERT INTO public.schema_migrations VALUES (45, '045_drop_reminders_table', '2026-05-05 13:39:26.103454');
INSERT INTO public.schema_migrations VALUES (46, '046_add_notification_tracking', '2026-05-05 13:39:26.107505');
INSERT INTO public.schema_migrations VALUES (47, '047_add_vehicle_milestone_tracking', '2026-05-05 13:39:26.109869');
INSERT INTO public.schema_migrations VALUES (48, '048_service_visit_overhaul', '2026-05-05 13:39:26.114084');
INSERT INTO public.schema_migrations VALUES (49, '049_remove_maintenance_schedule', '2026-05-05 13:39:26.122201');
INSERT INTO public.schema_migrations VALUES (50, '050_fix_service_line_items_schema', '2026-05-05 13:39:26.122479');
INSERT INTO public.schema_migrations VALUES (51, '051_add_i18n_user_preferences', '2026-05-05 13:39:26.124726');
INSERT INTO public.schema_migrations VALUES (52, '052_add_widget_api_keys', '2026-05-05 13:39:26.125303');
INSERT INTO public.schema_migrations VALUES (53, '053_metric_canonical_units', '2026-05-05 13:39:26.127636');
INSERT INTO public.schema_migrations VALUES (54, '054_extended_fuel_tracking', '2026-05-05 13:39:26.137931');
...
SELECT pg_catalog.setval('public.schema_migrations_id_seq', 54, true);
