...
class TestPhotoRoutes:
    ...
    async def test_list_photos(self, client: AsyncClient, auth_headers, test_vehicle_with_records):
    ...
    async def test_upload_invalid_format(self, client: AsyncClient, auth_headers, test_vehicle):
    ...
    async def test_upload_exceeds_size_limit(self, client: AsyncClient, auth_headers, test_vehicle):
    ...
    async def test_set_main_photo(self, client: AsyncClient, auth_headers, test_vehicle):
    ...
    async def test_upload_photo_vehicle_not_found(self, client: AsyncClient, auth_headers):
