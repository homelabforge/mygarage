...
class RecallBase(BaseModel):
    ...
    nhtsa_campaign_number: Optional[str] = Field(None, description="NHTSA campaign number", max_length=50)
    component: str = Field(..., description="Component affected by recall", min_length=1, max_length=200)
    ...
    date_announced: Optional[dt.date] = Field(None, description="Date recall was announced")
...
class RecallUpdate(BaseModel):
    ...
    nhtsa_campaign_number: Optional[str] = Field(None, description="NHTSA campaign number", max_length=50)
    component: Optional[str] = Field(None, description="Component affected by recall", min_length=1, max_length=200)
    summary: Optional[str] = Field(None, description="Summary of the recall issue", min_length=1)
    consequence: Optional[str] = Field(None, description="Potential consequences")
    remedy: Optional[str] = Field(None, description="Remedy for the recall")
    date_announced: Optional[dt.date] = Field(None, description="Date recall was announced")
    notes: Optional[str] = Field(None, description="User notes about the recall")
    is_resolved: Optional[bool] = Field(None, description="Whether recall has been resolved")
