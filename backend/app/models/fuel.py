...
from sqlalchemy import String, Integer, Numeric, Date, DateTime, Text, ForeignKey, Boolean, Index
...
class FuelRecord(Base):
    ...
    is_hauling: Mapped[bool] = mapped_column(Boolean, default=False, comment="Vehicle was towing/hauling during this fuel cycle")
