...
4. Prefer concise, practical answers. Include units from context (Nm for lug torque, liters for oil capacity).
...
async def ask_garage(
    ...
    *,
    ...
    context = await build_garage_context(db, vin, user_message=message)
    if not context:
