...
class GenericWindowStickerParser(BaseWindowStickerParser):
    ...
    def _extract_generic_options(self, text: str, data: WindowStickerData) -> None:
        ...
        skip_patterns = [
            'TOTAL', 'BASE', 'MSRP', 'PRICE', 'DESTINATION', 'DELIVERY',
            'FREIGHT', 'SUGGESTED', 'RETAIL', 'MANUFACTURER', 'WARRANTY',
            'ASSEMBLED', 'COUNTRY', 'ORIGIN', 'FINAL', 'VIN', 'MODEL',
        ]
    ...
    def _parse_equipment_section(self, section_text: str) -> list[str]:
        ...
        for line in section_text.split('\n'):
            ...
            if re.match(r'^(STANDARD|OPTIONAL|EQUIPMENT|FEATURES|SAFETY|INTERIOR|EXTERIOR|MECHANICAL)', line, re.IGNORECASE):
                continue
